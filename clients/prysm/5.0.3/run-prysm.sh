...
[ "$PRSYM_CLI_ACCEPT_TERMS_OF_USE" = "true" ] && append_option "--accept-terms-of-use" ""
...
[ "$PRSYM_CLI_DISABLE_MONITORING" = "true" ] && append_option "--disable-monitoring" ""
append_option "--e2e-config" "$PRSYM_CLI_E2E_CONFIG"
[ "$PRSYM_CLI_ENABLE_TRACING" = "true" ] &&  append_option "--enable-tracing" ""
...
[ "$PRSYM_CLI_ENABLE_DEBUG_RPC_ENDPOINTS" = "true" ] && append_option "--enable-debug-rpc-endpoints" ""
[ "$PRSYM_CLI_ENABLE_EXPERIMENTAL_BACKFILL" = "true" ] && append_option "--enable-experimental-backfill" ""
...
[ "$PRSYM_CLI_HISTORICAL_SLASHER_NODE" = "true" ] &&  append_option "--historical-slasher-node" ""
append_option "--http-mev-relay" "$PRSYM_CLI_HTTP_MEV_RELAY"
append_option "--http-modules" "$PRSYM_CLI_HTTP_MODULES"
append_option "--interop-eth1data-votes" "$PRSYM_CLI_INTEROP_ETH1DATA_VOTES"
...
[ "$PRSYM_CLI_SUBSCRIBE_ALL_SUBNETS" = "true" ] && append_option "--subscribe-all-subnets" ""
...
[ "$PRSYM_CLI_ENABLE_UPNP" = "true" ] &&  append_option "--enable-upnp" ""
...
[ "$PRSYM_CLI_P2P_STATIC_ID" = "true" ] &&  append_option "--p2p-static-id" ""
...
[ "$PRSYM_CLI_BLOB_SAVE_FSYNC" = "true" ] &&  append_option "--blob-save-fsync" ""
[ "$PRSYM_CLI_DISABLE_BROADCAST_SLASHINGS" = "true" ] && append_option "--dev" ""
[ "$PRSYM_CLI_DISABLE_BROADCAST_SLASHINGS" = "true" ] && append_option "--disable-broadcast-slashings" ""
[ "$PRSYM_CLI_DISABLE_EIP_4881" = "true" ] && append_option "--disable-eip-4881" ""
[ "$PRSYM_CLI_DISABLE_GRPC_CONNECTION_LOGGING" = "true" ] && append_option "--disable-grpc-connection-logging" ""
[ "$PRSYM_CLI_DISABLE_PEER_SCORER" = "true" ] && append_option "--disable-peer-scorer" ""
[ "$PRSYM_CLI_DISABLE_REGISTRATION_CACHE" = "true" ] && append_option "--disable-registration-cache" ""
[ "$PRSYM_CLI_DISABLE_RESOURCE_MANAGER" = "true" ] && append_option "--disable-resource-manager" ""
[ "$PRSYM_CLI_DISABLE_STAKING_CONTRACT_CHECK" = "true" ] && append_option "--disable-staking-contract-check" ""
[ "$PRSYM_CLI_DISABLE_VERBOSE_SIG_VERIFICATION" = "true" ] && append_option "--disable-verbose-sig-verification" ""
[ "$PRSYM_CLI_ENABLE_EXPERIMENTAL_STATE" = "true" ] && append_option "--enable-experimental-state" ""
[ "$PRSYM_CLI_ENABLE_FULL_SSZ_DATA_LOGGING" = "true" ] && append_option "--enable-full-ssz-data-logging" ""
[ "$PRSYM_CLI_ENABLE_HISTORICAL_STATE_REPRESENTATION" = "true" ] && append_option "--enable-historical-state-representation" ""
[ "$PRSYM_CLI_ENABLE_LIGHTCLIENT" = "true" ] && append_option "--enable-lightclient" ""
[ "$PRSYM_CLI_HOLESKY" = "true" ] && append_option "--holesky" ""
[ "$PRSYM_CLI_INTEROP_WRITE_SSZ_STATE_TRANSITIONS" = "true" ] &&  append_option "--interop-write-ssz-state-transitions" ""
[ "$PRSYM_CLI_MAINNET" = "true" ] && append_option "--mainnet" ""
[ "$PRSYM_CLI_PRATER" = "true" ] && append_option "--prater" ""
[ "$PRSYM_CLI_PREPARE_ALL_PAYLOADS" = "true" ] && append_option "--prepare-all-payloads" ""
[ "$PRSYM_CLI_SAVE_FULL_EXECUTION_PAYLOADS" = "true" ] && append_option "--save-full-execution-payloads" ""
[ "$PRSYM_CLI_SAVE_INVALID_BLOB_TEMP" = "true" ] && append_option "--save-invalid-blob-temp" ""
[ "$PRSYM_CLI_SAVE_INVALID_BLOCK_TEMP" = "true" ] && append_option "--save-invalid-block-temp" ""
[ "$PRSYM_CLI_SEPOLIA" = "true" ] && append_option "--sepolia" ""
[ "$PRSYM_CLI_SLASHER" = "true" ] &&  append_option "--slasher" ""
append_option "--genesis-state" "$PRSYM_CLI_GENESIS_STATE"
