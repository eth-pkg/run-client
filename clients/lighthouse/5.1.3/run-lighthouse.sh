...
[ "$LIGHTHOUSE_CLI_BN_ALLOW_INSECURE_GENESIS_SYNC" = "true" ] && append_option "--allow-insecure-genesis-sync" ""
[ "$LIGHTHOUSE_CLI_BN_ALWAYS_PREFER_BUILDER_PAYLOAD" = "true" ] && append_option "--always-prefer-builder-payload" ""
[ "$LIGHTHOUSE_CLI_BN_ALWAYS_PREPARE_PAYLOAD" = "true" ] && append_option "--always-prepare-payload" ""
[ "$LIGHTHOUSE_CLI_BN_BUILDER_FALLBACK_DISABLE_CHECKS" = "true" ] && append_option "--builder-fallback-disable-checks" ""
[ "$LIGHTHOUSE_CLI_BN_COMPACT_DB" = "true" ] && append_option "--compact-db" ""
[ "$LIGHTHOUSE_CLI_BN_DISABLE_BACKFILL_RATE_LIMITING" = "true" ] && append_option "--disable-backfill-rate-limiting" ""
[ "$LIGHTHOUSE_CLI_BN_DISABLE_DEPOSIT_CONTRACT_SYNC" = "true" ] && append_option "--disable-deposit-contract-sync" ""
[ "$LIGHTHOUSE_CLI_BN_DISABLE_DUPLICATE_WARN_LOGS" = "true" ] && append_option "--disable-duplicate-warn-logs" ""
[ "$LIGHTHOUSE_CLI_BN_DISABLE_ENR_AUTO_UPDATE" = "true" ] && append_option "--disable-enr-auto-update" ""
[ "$LIGHTHOUSE_CLI_BN_DISABLE_LOCK_TIMEOUTS" = "true" ] && append_option "--disable-lock-timeouts" ""
[ "$LIGHTHOUSE_CLI_BN_DISABLE_LOG_TIMESTAMP" = "true" ] && append_option "--disable-log-timestamp" ""
[ "$LIGHTHOUSE_CLI_BN_DISABLE_MALLOC_TUNING" = "true" ] && append_option "--disable-malloc-tuning" ""
[ "$LIGHTHOUSE_CLI_BN_DISABLE_OPTIMISTIC_FINALIZED_SYNC" = "true" ] && append_option "--disable-optimistic-finalized-sync" ""
[ "$LIGHTHOUSE_CLI_BN_DISABLE_PACKET_FILTER" = "true" ] && append_option "--disable-packet-filter" ""
[ "$LIGHTHOUSE_CLI_BN_DISABLE_PROPOSER_REORGS" = "true" ] && append_option "--disable-proposer-reorgs" ""
[ "$LIGHTHOUSE_CLI_BN_DISABLE_QUIC" = "true" ] && append_option "--disable-quic" ""
[ "$LIGHTHOUSE_CLI_BN_DISABLE_UPNP" = "true" ] && append_option "--disable-upnp" ""
[ "$LIGHTHOUSE_CLI_BN_DUMMY_ETH1" = "true" ] && append_option "--dummy-eth1" ""
[ "$LIGHTHOUSE_CLI_BN_ENABLE_PRIVATE_DISCOVERY" = "true" ] && append_option "--enable-private-discovery" ""
[ "$LIGHTHOUSE_CLI_BN_ENR_MATCH" = "true" ] && append_option "--enr-match" ""
[ "$LIGHTHOUSE_CLI_BN_ETH1" = "true" ] && append_option "--eth1" ""
[ "$LIGHTHOUSE_CLI_BN_ETH1_PURGE_CACHE" = "true" ] && append_option "--eth1-purge-cache" ""
[ "$LIGHTHOUSE_CLI_BN_GENESIS_BACKFILL" = "true" ] && append_option "--genesis-backfill" ""
[ "$LIGHTHOUSE_CLI_BN_GUI" = "true" ] && append_option "--gui" ""
[ "$LIGHTHOUSE_CLI_BN_HTTP" = "true" ] && append_option "--http" ""
[ "$LIGHTHOUSE_CLI_BN_HTTP_ALLOW_SYNC_STALLED" = "true" ] && append_option "--http-allow-sync-stalled" ""
[ "$LIGHTHOUSE_CLI_BN_HTTP_ENABLE_TLS" = "true" ] && append_option "--http-enable-tls" ""
[ "$LIGHTHOUSE_CLI_BN_IMPORT_ALL_ATTESTATIONS" = "true" ] && append_option "--import-all-attestations" ""
[ "$LIGHTHOUSE_CLI_BN_LIGHT_CLIENT_SERVER" = "true" ] && append_option "--light-client-server" ""
[ "$LIGHTHOUSE_CLI_BN_LOG_COLOR" = "true" ] && append_option "--log-color" ""
[ "$LIGHTHOUSE_CLI_BN_LOGFILE_COMPRESS" = "true" ] && append_option "--logfile-compress" ""
[ "$LIGHTHOUSE_CLI_BN_LOGFILE_NO_RESTRICTED_PERMS" = "true" ] && append_option "--logfile-no-restricted-perms" ""
[ "$LIGHTHOUSE_CLI_BN_METRICS" = "true" ] && append_option "--metrics" ""
[ "$LIGHTHOUSE_CLI_BN_PRIVATE" = "true" ] && append_option "--private" ""
[ "$LIGHTHOUSE_CLI_BN_PROPOSER_ONLY" = "true" ] && append_option "--proposer-only" ""
[ "$LIGHTHOUSE_CLI_BN_PURGE_DB" = "true" ] && append_option "--purge-db" ""
[ "$LIGHTHOUSE_CLI_BN_RECONSTRUCT_HISTORIC_STATES" = "true" ] && append_option "--reconstruct-historic-states" ""
[ "$LIGHTHOUSE_CLI_BN_RESET_PAYLOAD_STATUSES" = "true" ] && append_option "--reset-payload-statuses" ""
[ "$LIGHTHOUSE_CLI_BN_SHUTDOWN_AFTER_SYNC" = "true" ] && append_option "--shutdown-after-sync" ""
[ "$LIGHTHOUSE_CLI_BN_SLASHER" = "true" ] && append_option "--slasher" ""
[ "$LIGHTHOUSE_CLI_BN_STAKING" = "true" ] && append_option "--staking" ""
[ "$LIGHTHOUSE_CLI_BN_SUBSCRIBE_ALL_SUBNETS" = "true" ] && append_option "--subscribe-all-subnets" ""
[ "$LIGHTHOUSE_CLI_BN_VALIDATOR_MONITOR_AUTO" = "true" ] && append_option "--validator-monitor-auto" ""
[ "$LIGHTHOUSE_CLI_BN_ZERO_PORTS" = "true" ] && append_option "--zero-ports" ""
