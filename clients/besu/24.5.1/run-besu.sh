...
append_option "--auto-log-bloom-caching-enabled" "$BESU_CLI_AUTO_LOG_BLOOM_CACHING_ENABLED"
...
append_option "--compatibility-eth64-forkid-enabled" "$BESU_CLI_COMPATIBILITY_ETH64_FORKID_ENABLED"
...
append_option "--genesis-state-hash-cache-enabled" "$BESU_CLI_GENESIS_STATE_HASH_CACHE_ENABLED"
...
append_option "--receipt-compaction-enabled" "$BESU_CLI_RECEIPT_COMPACTION_ENABLED"
...
append_option "--revert-reason-enabled" "$BESU_CLI_REVERT_REASON_ENABLED"
...
append_option "--strict-tx-replay-protection-enabled" "$BESU_CLI_STRICT_TX_REPLAY_PROTECTION_ENABLED"
...
append_option "--miner-enabled" "$BESU_CLI_MINER_ENABLED"
append_option "--miner-extra-data" "$BESU_CLI_MINER_EXTRA_DATA"
append_option "--miner-stratum-enabled" "$BESU_CLI_MINER_STRATUM_ENABLED"
...
append_option "--discovery-enabled" "$BESU_CLI_DISCOVERY_ENABLED"
append_option "--max-peers" "$BESU_CLI_MAX_PEERS"
append_option "--p2p-enabled" "$BESU_CLI_P2P_ENABLED"
...
append_option "--random-peer-priority-enabled" "$BESU_CLI_RANDOM_PEER_PRIORITY_ENABLED"
append_option "--remote-connections-limit-enabled" "$BESU_CLI_REMOTE_CONNECTIONS_LIMIT_ENABLED"
...
append_option "--graphql-http-enabled" "$BESU_CLI_GRAPHQL_HTTP_ENABLED"
...
append_option "--engine-rpc-enabled" "$BESU_CLI_ENGINE_RPC_ENABLED"
append_option "--engine-rpc-port" "$BESU_CLI_ENGINE_RPC_PORT"
append_option "--json-pretty-print-enabled" "$BESU_CLI_JSON_PRETTY_PRINT_ENABLED"
...
append_option "--rpc-http-authentication-enabled" "$BESU_CLI_RPC_HTTP_AUTHENTICATION_ENABLED"
...
append_option "--rpc-http-enabled" "$BESU_CLI_RPC_HTTP_ENABLED"
...
append_option "--rpc-http-tls-ca-clients-enabled" "$BESU_CLI_RPC_HTTP_TLS_CA_CLIENTS_ENABLED"
append_option "--rpc-http-tls-cipher-suites" "$BESU_CLI_RPC_HTTP_TLS_CIPHER_SUITES"
append_option "--rpc-http-tls-client-auth-enabled" "$BESU_CLI_RPC_HTTP_TLS_CLIENT_AUTH_ENABLED"
append_option "--rpc-http-tls-enabled" "$BESU_CLI_RPC_HTTP_TLS_ENABLED"
...
append_option "--rpc-ws-authentication-enabled" "$BESU_CLI_RPC_WS_AUTHENTICATION_ENABLED"
...
append_option "--rpc-ws-enabled" "$BESU_CLI_RPC_WS_ENABLED"
...
append_option "--privacy-enabled" "$BESU_CLI_PRIVACY_ENABLED"
append_option "--privacy-flexible-groups-enabled" "$BESU_CLI_PRIVACY_FLEXIBLE_GROUPS_ENABLED"
append_option "--privacy-marker-transaction-signing-key-file" "$BESU_CLI_PRIVACY_MARKER_TRANSACTION_SIGNING_KEY_FILE"
append_option "--privacy-multi-tenancy-enabled" "$BESU_CLI_PRIVACY_MULTI_TENANCY_ENABLED"
append_option "--privacy-public-key-file" "$BESU_CLI_PRIVACY_PUBLIC_KEY_FILE"
append_option "--privacy-tls-enabled" "$BESU_CLI_PRIVACY_TLS_ENABLED"
...
append_option "--metrics-enabled" "$BESU_CLI_METRICS_ENABLED"
...
append_option "--metrics-push-enabled" "$BESU_CLI_METRICS_PUSH_ENABLED"
...
append_option "--permissions-accounts-config-file-enabled" "$BESU_CLI_PERMISSIONS_ACCOUNTS_CONFIG_FILE_ENABLED"
append_option "--permissions-accounts-contract-address" "$BESU_CLI_PERMISSIONS_ACCOUNTS_CONTRACT_ADDRESS"
append_option "--permissions-accounts-contract-enabled" "$BESU_CLI_PERMISSIONS_ACCOUNTS_CONTRACT_ENABLED"
append_option "--permissions-nodes-config-file" "$BESU_CLI_PERMISSIONS_NODES_CONFIG_FILE"
append_option "--permissions-nodes-config-file-enabled" "$BESU_CLI_PERMISSIONS_NODES_CONFIG_FILE_ENABLED"
append_option "--permissions-nodes-contract-address" "$BESU_CLI_PERMISSIONS_NODES_CONTRACT_ADDRESS"
append_option "--permissions-nodes-contract-enabled" "$BESU_CLI_PERMISSIONS_NODES_CONTRACT_ENABLED"
